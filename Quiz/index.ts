...
await askname();
await PIAIC();
let TypeQuizScore:number = 0
let JavaQuizScore:number = 0
let HTMLQuizScore:number = 0
let CSSQuizScore:number = 0
            //3rd step Quiz
async function Quiz(){
    do{
...
async function TypeScript(){
    const ans01 = await inquirer.prompt([{
        name:"Q01",
        type: "list",
        choices: ["A.  Array,Object,Boolean","B.  Boolean,Number,String","C.  Object,Array,Symbol","D.  Object,String,Number"],//     Boolean, Number, String
    ...
    const ans02 = await inquirer.prompt([{
        name:"Q02",
        type: "list",
        choices: ["A.  Extending","B.  Improving","C.  Duplicating","D.  Idolizing"],// Extending
    ...
    const ans04 = await inquirer.prompt([{
        name:"Q04",
        type: "list",
        choices: ["A.  string","B.  string | null","C.  string | undefined","D.  unknown"],//  string | undefined 
    ...
    const ans05 = await inquirer.prompt([{
        name:"Q05",
        type: "list",
        choices: ["A.  extending","B.  override","C.  overload","D.  inheriting"],//   override
...
async function JavaScript(){
    const ans01 = await inquirer.prompt([{
        name:"Q01",
        type: "list",
        choices: ["A.  <javascript>","B.  <scripting>","C.  <script>","D.  <js>"],//     <script>
    ...
    const ans02 = await inquirer.prompt([{
        name:"Q02",
        type: "list",
        choices: ["A.  alert('Hello World')","B.  msg('Hello World')","C.  alertBox('Hello World')","D.  msgBox('Hello World')"],//   alert("Hello World")
    ...
    const ans03 = await inquirer.prompt([{
        name:"Q03",
        type: "list",
        choices: ["A.  if i = 5","B.  if (i == 5)","C.  if i == 5 then","D.  if i = 5 then"],//    if (i == 5)  
    ...
    const ans04 = await inquirer.prompt([{
        name:"Q04",
        type: "list",
        choices: ["A.  <!--comment-->","B.  'comment","C.  //comment","D.  //comment//"],//      //comment
...
async function HTML(){
    const ans01 = await inquirer.prompt([{
        ...
        choices: ["A.  Hyper Text Markup Language","B.  Hyper Text Makeup Language",
                "C.  Hyper Tech Markup Language","D.  None of these"],//     Hyper Text Markup Language
    ...
    const ans02 = await inquirer.prompt([{
        name:"Q02",
        type: "list",
        choices: ["A.  Brendan Eich","B.  Sabeer Bhatiya","C.  Google Inc.","D.  Tim Berners-Lee"],//   Tim Berners-Lee
    ...
    const ans03 = await inquirer.prompt([{
        ...
        choices: ["A.  Document object model","B.  Data object model","C.  Document Oriented model",
                "D.  Data oriented model"],//    Document Object Model
    ...
    const ans04 = await inquirer.prompt([{
        name:"Q04",
        type: "list",
        choices: ["A.  <ul>","B.  <ol>","C.  <dl>","D.  <list> "],//      <ul>  
...
async function CSS(){
    const ans01 = await inquirer.prompt([{
        ...
        choices: ["A.  Computer Style Sheets","B.  Colorful Style Sheets",
                "C.  Cascading Style Sheets","D.  Creative Style Sheets"],//     Cascading Style Sheets
    ...
    const ans02 = await inquirer.prompt([{
        name:"Q02",
        type: "list",
        choices: ["A.  style","B.  font","C.  styles.","D.  class"],//   style
    ...
    const ans04 = await inquirer.prompt([{
        name:"Q04",
        type: "list",
        choices: ["A.  font-style","B.  text-size","C.  text-style","D.  font-size"],//      font-size
    ...
    const ans05 = await inquirer.prompt([{
        name:"Q05",
        type: "list",
        choices: ["A.  static","B.  relative","C.  fixed","D.  absolute"],//     static
